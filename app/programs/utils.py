    ...
    def decorator(func):
        def wrapper():
            ...
            try:
                ...
                return render_template(render_file, params=params, error=e.__str__(), instruction=instruction)
            else:
                return render_template(render_file, params=params, result=result, instruction=instruction)
        return wrapper
    return decorator
